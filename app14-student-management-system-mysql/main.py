...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        add_student_action = QAction(QIcon("../../../../Downloads/Code (1)/icons/add.png"), "Add Student", self)
        ...
        search_action = QAction(QIcon("../../../../Downloads/Code (1)/icons/search.png"), "Search", self)
